...
{
    public class MinFilter : RegionToolRegionFilter
    {
        ...
        {
            return Brushes.Transparent; //new SolidBrush(Color.FromArgb(127, Color.Silver));
        }
        ...
        public override PointD GetVelocity(Position.IVirtualMousePosition m)
        {
            ...
            double speedLimit = m_Param.C * 5 * GetStrength(m.GetVirtualPointD());
